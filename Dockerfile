...
COPY firestore_database.py conversation.py booking_rules.py date_parser.py booking_actions.py booking_view.py async_services.py notifications.py waitlist_service.py ./
