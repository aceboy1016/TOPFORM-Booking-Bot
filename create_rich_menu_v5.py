...
MUTE_TEXT_COLOR = (142, 142, 147) # #8E8E93 System Gray
...
def create_premium_menu_v5():
    print("Generating pure python premium image v5 with lag warning...")
    ...
    for path in font_paths:
        if os.path.exists(path):
            ...
            notice_font = ImageFont.truetype(path, 45) # Smaller for notice
            break
    ...
    draw_plus_icon(draw, cx, cy - 80, size=140, color=(255, 255, 255))
    ...
    # -- Notice Text (Bottom Center) --
    notice_text = "※カレンダーの反映に1分ほどかかる場合があります"
    draw.text((WIDTH // 2, HEIGHT - 60), notice_text, font=notice_font, fill=MUTE_TEXT_COLOR, anchor="mm")

    # Save
    img.save("rich_menu_v5.jpg", "JPEG", quality=95)
    print("Created rich_menu_v5.jpg")

if __name__ == "__main__":
    create_premium_menu_v5()
